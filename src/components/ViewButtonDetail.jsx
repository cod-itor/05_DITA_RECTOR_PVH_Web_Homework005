  ...
  return (
    <div>
      ...
      {isOpen && (
        ...
        >
          <div className="w-120 bg-gray-900 rounded-3xl p-5">
            <div className="flex justify-between items-center mb-4">
              <h1 className="font-bold text-lg text-white">Item Details</h1>
              <button
                onClick={onClose}
                className="bg-red-300 hover:bg-red-100 hover:cursor-pointer rounded-lg px-3 py-1 text-sm"
              >
                Close
              </button>
            </div>
